...
Si has descubierto una vulnerabilidad de seguridad en AeroGym, te pedimos que la reportes de manera responsable.
...
1. Descripción detallada de la vulnerabilidad y el vector de ataque.
2. Pasos claros para reproducir el fallo (proof of concept).
3. Impacto estimado en la privacidad o integridad de los datos de los usuarios.
